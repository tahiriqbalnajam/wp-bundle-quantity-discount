...
class Idl_Pricediscount_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'fonts/NeueKabel.otf', array(), $this->version, 'all' );
	...
	public function custom_show_reviews_after_title() {
	    global $product;
        ...
        if (wc_review_ratings_enabled()) {
            echo wc_get_rating_html($product->get_average_rating()) . ' <span class="rating-count">(' . $count . ')</span>';
        }
	}
}
