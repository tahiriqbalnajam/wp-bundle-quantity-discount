<div class="idl-bundle-discounts">
	<!--	<h4><?php // _e( 'Bundle Deals Available', 'idl-pricediscount' ); ?> </h4>-->
		...
		global $product;
        //$average = $product->get_average_rating(); // e.g. 4.3
        //$count   = $product->get_rating_count();   // e.g. 23
        //if ( $count > 0 ) {
            // This gives star icons
          //  echo wc_get_rating_html( $average ) . ' <span class="rating-count">(' . $count . ')</span>';
        //}
		...
		<div class="discount-option bundle-option" data-type="bundle" data-index="default" data-product-id="<?php echo esc_attr( $product->get_id() ); ?>">
		    <label>
		        <div class="bundle-info-main">
			        <div class="bundle-info bundle-info-first">
			            <div class="bundle-left-content">
			                <div class="discount_option discount_option_inner">
			                ...
			                <div class="discount-description">1 Set of Wheels</div>
			            </div>
		            ...
		            <div class="bundle-product-list"><ul>
		                <li>
		                    ...
		                    if ( $main_image_id ) {
		                     ...
		                     echo ' <span class="inner-free-text2">&nbsp;'.$product->get_name() .'</span>';
			        ...
			        <div class="bundle-products">
			            ...
			            foreach ( $bundle_products as $bundle_product_id ) {
				            ...
				            if ( $bundle_product ) {
					            ...
					            if($count == 0){
					                echo ' <span class="inner-free-text2">+ &nbsp;'.$bundle_product->get_name() .'</span></li>';
					            }
					            else{
					                echo ' <span class="inner-free-text">+ &nbsp;'.$bundle_product->get_name() .'</span></li>';
					            }
					            $count++;
		...
		<div class="dislay-addtocart-buttun">
		    <button type="button" class="button alt idl-add-to-cart-btn" data-type="bundle" data-index="<?php echo esc_attr( $index ); ?>" data-product-id="<?php echo esc_attr( $product->get_id() ); ?>">
